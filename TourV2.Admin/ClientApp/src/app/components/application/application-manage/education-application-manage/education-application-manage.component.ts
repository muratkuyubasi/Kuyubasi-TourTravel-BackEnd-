...
@Component({
  selector: 'app-education-application-manage',
  templateUrl: './education-application-manage.component.html',
  styleUrls: ['./education-application-manage.component.css']
})
export class HajjApplicationManageComponent extends BaseComponent implements OnInit {
  ...
  updateManageForm() {
    ...
    if (this.manageForm.valid) {
      ...
      this.sub$.sink = this.applicationService.updateHajjCandidate(candidate).subscribe(() => {
