...
using TourV2.Admin.Controllers;
using TourV2.Data.Dto;
using TourV2.MediatR.Commands;
using TourV2.MediatR.Handlers;
using TourV2.MediatR.Queries;

namespace TourV2.WEBAPI.Controllers
{
    ...
    public class ContactController : BaseController
    {
        ...
        [HttpGet("GetAllTourRequests")]
        [Produces("application/json", "application/xml", Type = typeof(List<ContactMessageDto>))]
        public async Task<IActionResult> GetAllTourRequests()
        {
            var query = new GetAllTourRequestsQuery { };
            var result = await _mediator.Send(query);
            return Ok(result);
        }
        ...
        ///<returns></returns>
        ///
        [HttpPost("AddTourRequest")]
        [Produces("application/json", "application/xml", Type = typeof(ContactMessageDto))]
        public async Task<IActionResult> AddTourRequest(AddTourRequestCommand addTourRequestCommandHandler)
        {
            var response = await _mediator.Send(addTourRequestCommandHandler);
