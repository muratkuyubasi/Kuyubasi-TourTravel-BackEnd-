...
{
    public class AddContactMessageCommandHandler : IRequestHandler<AddContactMessageCommand, ServiceResponse<ContactMessageDto>>
    {
        ...
        public AddContactMessageCommandHandler(IContactMessageRepository ContactMessageRepository, IMapper mapper, ILogger<AddContactMessageCommandHandler> logger,
        ...
        public async Task<ServiceResponse<ContactMessageDto>> Handle(AddContactMessageCommand request, CancellationToken cancellationToken)
        {
